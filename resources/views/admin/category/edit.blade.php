        ...
        <div class="container mx-auto">
            ...
            <div class="w-full md:w-5/6 sm:w-9/12 mx-auto my-10 bg-white p-5 rounded-md shadow-sm">
                <div class="text-center">
                    <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Редактирование категории</h1>
                    <p class="text-gray-400 dark:text-gray-400">Измените следующую информацию</p>
                </div>
                <div class="m-7">
                    <form action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="name" name="name" value="{{ $category->name }}" placeholder="Мобильные телефоны" required class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" />
                        </div>
                        <div class="mb-6">
                            <label for="alias" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Alias</label>
                            <input type="text" id="alias" name="alias" value="{{ $category->alias }}" placeholder="Mobile" required class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" />
                        </div>
                        <div class="mb-6">
                            <label for="desc" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Описание</label>
                            <textarea rows="5" id="desc" name="desc" placeholder="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque, totam!" class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" required>{{ $category->decs }}</textarea>
                        </div>
                        <div class="mb-6">
